...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full border border-gray-200 dark:bg-black dark:border-white/[0.2] bg-white shadow-input flex items-center justify-between px-8 py-4"
    >
      {children}
    </nav>
  );
